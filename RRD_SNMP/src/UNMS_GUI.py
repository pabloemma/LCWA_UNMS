...
class MyFrame(wx.Frame):
    ...
    def __init__(self,parent,id,title):
        ...
        vs =wx.StaticText(panel,-1,self.version, (100,20),(500,100),wx.ALIGN_LEFT)
        font1 = wx.Font(20,wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, True)
        font2 = wx.Font(20,wx.FONTFAMILY_MODERN, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_BOLD, True)
        vs.SetFont(font2)
        vk =wx.StaticText(panel,-1,self.author, (100,70),(160,50),wx.ALIGN_LEFT)
        #vl =wx.StaticText(panel,-1,self.date, (100,120),(160,30),wx.ALIGN_LEFT)
        vm =wx.StaticText(panel,-1,self.UNMSversion, (100,150),(160,50),wx.ALIGN_CENTER)
        #vn =wx.StaticText(panel,-1,self.dt_string, (100,230),(160,50),wx.ALIGN_RIGHT)
        font = wx.Font(10,wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, True)
        vk.SetFont(font2)
        #vl.SetFont(font)
        vm.SetFont(font)
        #vn.SetFont(font)
